...
class PriceResourceIT {
    ...
    void shouldFindTest1_OK(){
        ...
        this.webTestClient
                ...
                .value(priceDto -> assertEquals(new BigDecimal("35.50"), priceDto.getPrice()))
    ...
    void shouldFindTest2_OK(){
        ...
        this.webTestClient
                ...
                .expectStatus().isOk()
                .expectBody(PriceDto.class)
                .value(priceDto -> assertEquals(new BigDecimal("25.45"), priceDto.getPrice()))
                .value(priceDto -> assertEquals(startDateExpect, priceDto.getStartDate()))
                .value(priceDto -> assertEquals(endDateExpect, priceDto.getEndDate()))
                .value(priceDto -> assertEquals(1, priceDto.getBrandId()))
    ...
    void shouldFindTest4_OK(){
        ...
        this.webTestClient
                ...
                .expectStatus().isOk()
                .expectBody(PriceDto.class)
                .value(priceDto -> assertEquals(new BigDecimal("30.50"), priceDto.getPrice()))
                .value(priceDto -> assertEquals(startDateExpect, priceDto.getStartDate()))
                .value(priceDto -> assertEquals(endDateExpect, priceDto.getEndDate()))
                .value(priceDto -> assertEquals(1, priceDto.getBrandId()))
    ...
    void shouldFindTest5_OK(){
        ...
        this.webTestClient
                ...
                .expectStatus().isOk()
                .expectBody(PriceDto.class)
                .value(priceDto -> assertEquals(new BigDecimal("38.95"), priceDto.getPrice()))
                .value(priceDto -> assertEquals(startDateExpect, priceDto.getStartDate()))
                .value(priceDto -> assertEquals(endDateExpect, priceDto.getEndDate()))
                .value(priceDto -> assertEquals(1, priceDto.getBrandId()))
